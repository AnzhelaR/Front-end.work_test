...
const path = {
    ...
    src: {
        ...
        js: srcPath + "js/*.js",
        images: srcPath + "images/**/*.{jpeg,jpg,png,gif,webp}",
        svgIcons: srcPath + "svgIcons/**/*.svg",
    ...
    watch: {
        ...
        css: srcPath + "scss/**/*.scss",
        js: srcPath + "js/**/*.js",
        images: srcPath + "images/**/*.{jpg,jpeg,png,gif,webp}",
        svgIcons: srcPath + "svgIcons/**/*.svg",
        fonts: srcPath + "fonts/**/*.{woff,woff2,ttf,eot,svg}",
    },
    clean: "./" + distPath
...
function sprite() {
    return src(path.src.svgIcons, { base: srcPath + "svgIcons/*.svg" })
        .pipe(svgSprite({
            mode: {
                stack: {
                    sprite: "../sprite.svg",
...
const build = gulp.series(clean, gulp.parallel(html, sprite, images, css, js))
